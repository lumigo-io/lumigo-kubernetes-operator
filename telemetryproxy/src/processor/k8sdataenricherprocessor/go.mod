...
require (
	...
	golang.org/x/net v0.17.0 // indirect; Override indirect dependencies
	google.golang.org/grpc v1.58.3 // indirect; Override indirect dependencies
	k8s.io/api v0.28.2
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/processor/k8sdataenricherprocessor/internal => ./internal
