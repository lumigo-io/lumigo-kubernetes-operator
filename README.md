...
| [Resource Labels](#opting-in-for-specific-resources) | More granular control - can target specific resources without affecting the entire namespace | Uses default Lumigo project | Focused only on tracing | Only labeled resources are mutated to add auto-instrumentation |
